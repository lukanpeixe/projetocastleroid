...
{
	public class pd_quadro_gosma : ModTile
	{
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.CopyFrom(TileObjectData.Style1xX);//Este é o segredo vou tabelar os estilos de objectData
			...
			AddMapEntry(new Color(200, 200, 200), "Gosma");
		}

		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			Item.NewItem(i * 16, j * 16, 32, 48, mod.ItemType("pd_quadro_gosma_item"));
		}
		/*
